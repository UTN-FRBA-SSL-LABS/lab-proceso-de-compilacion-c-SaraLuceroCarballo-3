...
> **R:** porque se copio todo el contenido que habia en el programa.c
...
> **R:**Ocurre porque en el preprocesamiento se eliminan los comentarios, que es donde estaba la palabra clave a buscar, por ende no encuentra nada al ser parte del comentario.
...
> **R:** 369:# 130 "/usr/include/stdio.h" 2 3 4 557:# 120 "/usr/include/x86_64-linux-gnu/bits/floatn.h" 2 3 4 1026:# 130 "/usr/include/x86_64-linux-gnu/sys/types.h" 2 3 4 1242:# 180 "/usr/include/x86_64-linux-gnu/sys/types.h" 2 3 4 1948:    printf("=== Laboratorio de Compilacion en C (v%s) ===\n\n", "1.0"); 1957:    printf("CUADRADO(%d)      = %d\n", 5, ((5) * (5)));
...
> **R:**El primer comando no tuvo ninguna salida. El segundo comando en cambio obtuvo printf("[DEBUG] %s\n", ("Iniciando main")); como salida
...
> **R:** N da el numero de linea y "archivo" da el nombre del archivo o la ruta original de donde viene el código. La declaración printf proviene del archivo stdio.h
...
> **R:** porque en programa.o el archivo no tiene instruciones o no esta definido(tipo U), mientra que en matematica.o si se define y se implementa (Tipo T).
...
> **R:**Permission denied = permido denegado
...
> **R:** CUADRADO(X) desaparece en la estapa 1,preprocesamiento, y no tiene verificación de tipo. Por otro lado, sumar(a,b) si tiene verificación de tipo y no desaparece. 
...
> **R:** Tipo T representa código ejecutable y vive en las funciones como sumar. En cambio, Tipo D representa variables de valor inicial como int a=5, y viven en la sección data
